...
public class ParseTVInfo {
    private static List<TV> serials;

    public static TV getMovieById(int tvId) {
        final String URL_TO_PARSE_DETAILS = "https://api.themoviedb.org/3/tv/" + tvId + "?api_key=52cc54558595d4caee5f1c68a7e7396f";
        TV tv = null;
...
//            tv = new TV(id, title, adult, backdropPath,
...
//                    status, tagline, video, voteAverage, voteCount);
    ...
    public static List<TV> getMovies(String searchName) {
        final String URL_TO_PARSE_MOVIES = "https://api.themoviedb.org/3/search/tv?api_key=52cc54558595d4caee5f1c68a7e7396f&query=" + searchName;
...
//                TV tv = new TV(id, title, adult, backdropPath,
